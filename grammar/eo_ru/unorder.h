...
{
   @Структура  хвост2 = 
               гр_сущ_1В  опр_прилагательный1_И  _обстоятельство ;
   @Структура  хвост2 = 
               гр_сущ_1В( &Ч, &Л, %В, &Р ) 
	       опр_прилагательный1_И( Р, @0, %Т, Ч ) 
	      _обстоятельство ;
}
@Перевод
{     
...
@Перевод
{
   @Выбор     _дополнение_а = дополнение хвост2 @00 ;
   @Выбор     _дополнение_а = дополнение хвост2 @00 ;
}
// --------------------------------------------------------------------------
@Перевод
{
   @Выбор     хвост_esti_1 = 
	      ...
	      прил_как_сущ_И // а в гр_сущ_1И он закоментировал
