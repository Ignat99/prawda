...
/********************************************************************/
t_String :: t_String( const char *Str1 )
{   short L=1+strlen( Str1 );
    Str=(char *)calloc( L,sizeof(char) );
    strcpy( Str,Str1 );
    Length=L ;
}
/********************************************************************/
t_String :: t_String( const t_String &Str1 )
{
    short L=1+strlen( Str1.Str );
    Str=(char *)calloc( L,sizeof(char) );
    Length=L ;
    strcpy( Str, Str1.Str );
}
...
/********************************************************************/
t_String & t_String :: operator = ( const char *Str1 )
{
    short L=1+strlen( Str1 );
    if( Length<L )
...
/********************************************************************/
t_String & t_String :: operator = ( const t_String &Str1 )
{
    short L=1+strlen( Str1.Str );
    if( Length<L )
    {   Str=(char *)realloc( Str, L*sizeof(char) );
...
/********************************************************************/
void t_String :: operator +=( char c )
{
    short L=strlen( Str );
    if( Length<L+3 )
    {   Str=(char *)realloc( Str, (Length+20)*sizeof(char) );
        Length+=20 ;
    }
    Str[L]=c ;
    Str[L+1]=0 ;
...
/********************************************************************/
void t_String :: operator +=( const char *Str1 )
{
    short L =1+strlen( Str );
    short L1=1+strlen( Str1 );
    if( Length<L+L1 )
    {   Str=(char *)realloc( Str, (L+L1)*sizeof(char) );
        Length=L+L1 ;
    }
    strcat( Str, Str1 );
}
/********************************************************************/
void t_String :: operator +=( const t_String &Str1 )
{
    short L =1+strlen( Str );
    short L1=1+strlen( Str1.Str );
    if( Length<L+L1 )
    {   Str=(char *)realloc( Str, (L+L1)*sizeof(char) );
        Length=L+L1 ;
    }
...
/********************************************************************/
char t_String :: operator []( int i )
{
   if( i<0 || Length<=i ) return 0 ;
   return Str[i] ;
}
/********************************************************************/
void t_String :: resize( int n )
{
